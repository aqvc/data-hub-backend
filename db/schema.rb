...
ActiveRecord::Schema[7.2].define(version: 2026_04_13_100000) do
...
# Could not dump table "investment_strategies" because of following StandardError
#   Unknown type 'sector' for column 'sector_investment_focus'
